...
:class:`CandidateCatalog` is fixed at fit time. :class:`MutableCandidateCatalog`
is the one that grows, which is why it carries the bulk of this module: adding
an item has to keep the feature space, the identifiers and the stored scores
